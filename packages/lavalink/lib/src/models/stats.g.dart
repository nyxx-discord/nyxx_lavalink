...
CpuStats _$CpuStatsFromJson(Map<String, dynamic> json) =>
    CpuStats(cores: (json['cores'] as num).toInt(), systemLoad: (json['systemLoad'] as num).toDouble(), lavalinkLoad: (json['lavalinkLoad'] as num).toDouble());

FrameStats _$FrameStatsFromJson(Map<String, dynamic> json) =>
    FrameStats(sent: (json['sent'] as num).toInt(), nulled: (json['nulled'] as num).toInt(), deficit: (json['deficit'] as num).toInt());
